            ...
            <div class="ibox-content">
                <form class="form-horizontal" method="post" action="{{ URL::asset('personal/editar') }}">
                    ...
                    <div class="form-group{{ $errors->has('nombre') ? ' has-error' : '' }}"><label class="col-lg-2 control-label">Nombre</label>
                        ...
                        <div class="col-lg-10"><input type="text" name="nombre" placeholder="Ejemplo: Jhon Doe" class="form-control" value="{{ $data_personal->nombre }}"> @if ($errors->has('nombre'))
                    ...
                    <div class="form-group{{ $errors->has('nro_empleado') ? ' has-error' : '' }}"><label class="col-lg-2 control-label">Nro empleado</label>
                        ...
                        <div class="col-lg-10"><input type="text" name="nro_empleado" placeholder="Ejemplo: 225" class="form-control" value="{{$data_personal->nro_empleado}}"> @if ($errors->has('nro_empleado'))
                                <span class="help-block">
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Departamentos</label>
