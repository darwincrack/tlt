...
>>>>>>> 04556630176ba3755f3ca0eda02490a8038c2cd1
                    ...
                    <div class="col-lg-10">
                        <div  id="data_1">
                            ...
                            <div class="input-group date">
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" name="fecha_adquisicion" id="fecha_adquisicion" class="form-control" value="{{ date('d-m-Y', strtotime($data_articulo->fecha_adquisicion)) }}">
