...
@section('content')
    ...
    <div class="ibox float-e-margins animated fadeInDown">
        ...
        <div class="ibox-content">
            <form class="form-horizontal" method="post" action="{{ URL::asset('horario/editar') }}">
                {!! csrf_field() !!}
                                ...
                                <td>
                                    <div class="input-group clockpicker" data-autoclose="true">
                                        <input type="text" class="form-control" name="{{$semana[$i].'_entrada'}}"
                                               @foreach ($data_horarios as $data_horario)

                                               <?php $inicio_ciclo   =   $data_horario->inicio_ciclo;
                                               $fin_ciclo      =   $data_horario->fin_ciclo;?>

                                               @if ($data_horario->dia_semana==$i)
                                               value=" {{$data_horario->hora_entrada}}"
                                                @endif
                                                @endforeach
                                        >
                                ...
                                <td>
                                    <div class="input-group clockpicker" data-autoclose="true">
                                        <input type="text" class="form-control"   name="{{$semana[$i].'_salida'}}"
                                               ...
                                               @foreach ($data_horarios as $data_horario)
                                               @if ($data_horario->dia_semana==$i)
                                               value=" {{$data_horario->hora_salida}}"
                                                @endif
                                                @endforeach
                                        >
                                        <span class="input-group-addon">
                    ...
                    <div class="col-lg-10">
                        <div class="switch">
                            <div class="onoffswitch">
                                <input type="checkbox"    class="onoffswitch-checkbox" id="lactancia" name="lactancia" value="1"  {{($lactancia>=1)?"checked=":'null'}}  >
                    ...
                    <div class="col-lg-10">
                        <div  id="data_1">
                            ...
                            <div class="input-group date">
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" name="inicio_asignacion" id="inicio_asignacion" class="form-control" value="{{ date('d-m-Y', strtotime($inicio_ciclo)) }}">
                ...
                <div class="form-group{{ $errors->has('fin_asignacion') ? ' has-error' : '' }}"><label class="col-lg-2 control-label">Fin Asignacion</label>
                    ...
                    <div class="col-lg-10">
                        <div  id="data_1">
                            ...
                            <div class="input-group date">
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" name="fin_asignacion" id="fin_asignacion" class="form-control" value="{{ date('d-m-Y', strtotime($fin_ciclo)) }}">
