@extends('layouts.template')
    ...
    @push('boton_accion')
    <a href="{{ url('/departamento/add') }}" class="btn btn-primary">
    ...
    $(function() {
        $('#users-table').DataTable({
            ...
            buttons: [
                { extend: 'copy'},
                {extend: 'csv'},
                {extend: 'excel', title: 'Reporte de Departamentos',  exportOptions: {
                    columns: [ 0, 1, 2,3 ]
                }},
                {extend: 'pdf', title: 'Reporte de Departamentos', exportOptions: {
                    columns: [ 0, 1, 2, 3 ]
                }},
