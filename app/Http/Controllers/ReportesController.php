            ...
            ->addColumn('action', function ($personal)  {
                ...
                if(Entrust::hasRole(['admin', 'operador']))
                {
                    if($personal->tipo_falta == "2" or $personal->tipo_falta == "3" or $personal->tipo_falta == "7" or $personal->tipo_falta == "8" or $personal->tipo_falta == "11"){
                        ...
                        {
                                return '<a href="justificativos/ver/'.$personal->justificativos.'" class="btn btn-xs label-warning-light" title="Ver Justificativo"><i class="fa fa-file-pdf-o"></i> ver</a>';
                        }
                    }
                    else
                    {
                    ...
                    {
                        return '<a href="justificativos/ver/'.$personal->justificativo.'" class="btn btn-xs label-warning-light" title="Ver Justificativo"><i class="fa fa-file-pdf-o"></i> ver</a>';
                    }
