...
class ConfiguracionModels
{
    ...
    static public function editar($nombre_sistema,$nombre_corto_sistema,$prioridad,$nombre_logo)
    {



        DB::table('Configuracion')
            ->update( [ 'nombre_sistema' => $nombre_sistema, 'nombre_corto_sistema' => $nombre_corto_sistema, 'prioridad' => $prioridad, 'path_logo' => $nombre_logo]);
